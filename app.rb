...
def make_imageList(color1="#BADA55", color2="transparent", color3="transparent", color4="transparent", color5="transparent", width=100, height=100)
  ...
  imgs.new_image(width, height) { self.background_color = color_convert(color1) }
  imgs.new_image(width, height) { self.background_color = color_convert(color2) }
  imgs.new_image(width, height) { self.background_color = color_convert(color3) }
  imgs.new_image(width, height) { self.background_color = color_convert(color4) }
  imgs.new_image(width, height) { self.background_color = color_convert(color5) }
  return imgs
end
...
def color_convert(original)
  ...
  return original if color_strings.include?(original)
  return "##{original}" if /[a-fA-F0-9]{3}|[a-fA-F0-9]{6}/.match(original)
  return "transparent"
end
